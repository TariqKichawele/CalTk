...
import { aboutSettingsSchema, EventTypeServerSchema, onboardingSchema } from "./lib/zodSchemas";
...
export async function updateEventAction(
    prevState: any, { eventTypeId, isChecked } : { eventTypeId: string, isChecked: boolean }
) {
    try {
        const session = await requireUser();
